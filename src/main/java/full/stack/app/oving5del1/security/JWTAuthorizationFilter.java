package full.stack.app.oving5del1.security;

import com.auth0.jwt.JWT;
import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.exceptions.JWTVerificationException;
import full.stack.app.oving5del1.controller.TokenController;
...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
    ...
    public String validateTokenAndGetUserId(final String token) {
        try {
            final Algorithm hmac512 = Algorithm.HMAC512(TokenController.SECRET_KEY);;
